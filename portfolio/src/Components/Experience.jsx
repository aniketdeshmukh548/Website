    ...
    const iconsarr=[
        {
            ...
            id:7,src:graphql,title:'Graph QL',style:'shadow-pink-400'
        },{
            id:8,src:github,title:'GitHub',style:'shadow-gray-500'
        }
    ]
  return (
    <div name='exp' className=' bg-gradient-to-b from-gray-800 to-black w-full h-screen'>
        <div className=' max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full text-white'>
            <div>
                <p className=' text-4xl font-bold border-b-4 border-gray-500 p-2 inline'>Experience</p>
                <p className=' py-6'>Technologies on which I have worked.</p>
            </div>
            <div className='w-full grid grid-cols-2 sm:grid-cols-3 gap-8 text-center py-8 px-12 sm:px-0'>

                {
                    iconsarr.map(({id,src,title,style})=>(
